...
void setup() {
  ...
  ArduinoDmx0.set_control_pin(2);   // Arduino output pin for MAX485 input/output control (connect to MAX485-1 pins 2-3)(-1 not used)
    ...
    if (memcmp(packetBuffer, "Art-Net", 8) == 0) {
      ...
      switch (opCode) {
        ...
        case 0x2100:  //"ArtPollReply"
          break;
        case 0x2300:  //"ArtDiagData"
          break;
        case 0x2400:  //"ArtCommand"
          break;
        case 0x5000:  //"ArtDmx"
          if (packetBuffer[15] == intN && packetBuffer[14] == intUniverse) {
            counter = 0;
            memcpy(ArduinoDmx0.TxBuffer, packetBuffer + 18, 512);
          }
          break;
        case 0x5100:  //"ArtNzs"
          break;
        ...
        case 0x6000:  //"ArtAddress "
          ...
          displaydata();
          break;
        case 0x7000:  //"ArtInput"
          break;
        case 0x8000:  //"ArtTodRequest"
          break;
        case 0x8100:  //"ArtTodData"
          break;
        case 0x8200:  //"ArtTodControl"
          break;
        case 0x8300:  //"ArtRdm"
          break;
        case 0x8400:  //"ArtRdmSub"
          break;
        case 0xA010:  //"ArtVideoSetup"
          break;
        case 0xA020:  //"ArtVideoPalette"
          break;
        case 0xA040:  //"ArtVideoData"
          break;
        case 0xF000:  //"ArtMacMaster (Deprecated)"
          break;
        case 0xF100:  //"ArtMacSlave (Deprecated)"
          break;
        case 0xF200:  //"ArtFirmwareMaster"
          break;
        case 0xF300:  //"ArtFirmwareReply"
          break;
        case 0xF400:  //"ArtFileTnMaster"
          break;
        case 0xF500:  //"ArtFileFnMaster"
          break;
        case 0xF600:  //"ArtFileFnReply"
          break;
        case 0xF800:  //"ArtIpProg"
          ArtIpProg();
          updateNodeReportCounter();
          displaydata();
          sendArtIpProgReply();
          break;
        case 0xF900:  //"ArtIpProgReply"
          break;
        case 0x9000:  //"ArtMedia"
          break;
        case 0x9100:  //"ArtMediaPatch"
          break;
        case 0x9200:  //"ArtMediaControl"
          break;
        case 0x9300:  //"ArtMediaControlReply"
          break;
        case 0x9700:  //"ArtTimeCode"
          break;
        case 0x9800:  //"ArtTimeSync"
          break;
        case 0x9900:  //"ArtTrigger"
          break;
        case 0x9A00:  //"ArtDirectory"
          break;
        case 0x9B00:  //"ArtDirectoryReply"
          break;
        default:  //"Unknown Art-Net packet
...
void makeArtPollReply() {
  ...
  if (EEPROM.read(537) > 0) {
    ...
    ArtPollReply[26] = byte('D');  //Short Name [18]
    ArtPollReply[27] = byte('M');
    ArtPollReply[28] = byte('X');
    //...
  }
  ...
  if (EEPROM.read(555) > 0) {
    ...
    ArtPollReply[58] = byte('D');
    ArtPollReply[59] = byte('M');
    ArtPollReply[60] = byte('X');
    //...
  }
...
void ArtAddress() {
  ...
  if (packetBuffer[106] != 0) {  //Command
    ...
    switch (packetBuffer[106]) {
      case 0x00:  // "AcNone" No action
        break;
      case 0x01:  // "AcCancel" Merge If Node is currently in merge mode, cancel merge mode upon receipt of next ArtDmx packet. See discussion of merge mode operation.

        break;
      case 0x02:                  // "AcLedNormal" The front panel indicators of the Node operate normally.
        ArtPollReply[23] = 0xE0;  // Status1
        EEPROM.update(535, 2);    // Status 1 (normal)
        ledNormal();
        break;
      case 0x03:                  // "AcLedMute" The front panel indicators of the Node are disabled and switched off.
        ArtPollReply[23] = 0xA0;  // Status1
        EEPROM.update(535, 3);    // Status 1 (mute)
        ledMute();
        break;
      case 0x04:                  // "AcLedLocate" Rapid flashing of the Node’s front panel indicators. It is intended as an outlet identifier for large installations.
        ArtPollReply[23] = 0x60;  // Status1
        EEPROM.update(535, 4);    // Status 1 (identify)
        ledIdentify();
        break;
      case 0x05:  // "AcResetRx Flags" Resets the Node’s Sip, Art-Net 4 Protocol Release V1.4 Document Revision 1.4dh 19/7/2023 - 39 - Text, Test and data error flags. If an output short is being flagged, forces the test to re-run.
        break;
      case 0x06:  // "AcAnalysisOn" Enable analysis and debugging mode.
        break;
      case 0x07:  // "AcAnalysisOff" Disable analysis and debugging mode.
        break;
        // Failsafe configuration commands: These settings should be retained by the node during power cycling
      case 0x08:  //"AcFailHold" Set the node to hold last state in the event of loss of network data.
        //EEPROM.update(534, 0);  // disable BootScene
        EEPROM.update(536, 0x20);
        ArtPollReply[217] = 0x20;  //Hold
        break;
      case 0x09:  //"AcFailZero" Set the node’s outputs to zero in the event of loss of network data.
        EEPROM.update(536, 0x60);
        ArtPollReply[217] = 0x60;  //zero
        FailZero();
        break;
      case 0x0A:  //"AcFailFull" Set the node’s outputs to full in the event of loss of network data.
        EEPROM.update(536, 0xA0);
        ArtPollReply[217] = 0xA0;  //full
        FailFull();
        break;
      case 0x0B:  // "AcFailScene" Set the node’s outputs to play the failsafe scene in the event of loss of network data.
        //EEPROM.update(534, 1);  // Enable BootScene
        EEPROM.update(536, 0xE0);
        ArtPollReply[217] = 0xE0;  //Playback
        PlayBootScene();
        break;
      case 0x0C:  // "AcFailRecord" Record the current output state as the failsafe scene.
        //EEPROM.update(534, 1);  // Enable BootScene
        RecordBootScene();
        break;
      // Node configuration commands: Note that Ltp / Htp and direction settings should be retained by the node during power cycling.
      case 0x10:  // "AcMergeLtp0" Set DMX Port 0 to Merge in LTP mode.
        break;
      case 0x11:  // "AcMergeLtp1" Set DMX Port 1 to Merge in LTP mode.
        break;
      case 0x12:  // "AcMergeLtp2" Set DMX Port 2 to Merge in LTP mode.
        break;
      case 0x13:  // "AcMergeLtp3" Set DMX Port 3 to Merge in LTP mode.
        break;
      case 0x20:  // "AcDirectionTx0" Set Port 0 direction to output.
        break;
      case 0x21:  // "AcDirectionTx1" Set Port 1 direction to output.
        break;
      case 0x22:  // "AcDirectionTx2" Set Port 2 direction to output.
        break;
      case 0x23:  // "AcDirectionTx3" Set Port 3 direction to output.
        break;
      case 0x30:  // "AcDirectionRx0" Set Port 0 direction to input.
        break;
      case 0x31:  // "AcDirectionRx1" Set Port 1 direction to input.
        break;
      case 0x32:  // "AcDirectionRx2" Set Port 2 direction to input.
        break;
      case 0x33:  // "AcDirectionRx3" Set Port 3 direction to input.
        break;
      case 0x50:  // "AcMergeHtp0" Set DMX Port 0 to Merge in HTP (default) mode.
        break;
      case 0x51:  // "AcMergeHtp1" Set DMX Port 1 to Merge in HTP (default) mode.
        break;
      case 0x52:  // "AcMergeHtp2" Set DMX Port 2 to Merge in HTP (default) mode.
        break;
      case 0x53:  // "AcMergeHtp3" Set DMX Port 3 to Merge in HTP (default) mode.
        break;
      case 0x60:  // "AcArtNetSel0" Set DMX Port 0 to output both DMX512 and RDM packets from the Art-Net protocol (default).
        break;
      case 0x61:  // "AcArtNetSel1" Set DMX Port 1 to output both DMX512 and RDM packets from the Art-Net protocol (default).
        break;
      case 0x62:  // "AcArtNetSel2" Set DMX Port 2 to output both DMX512 and RDM packets from the Art-Net protocol (default).
        break;
      case 0x63:  // "AcArtNetSel3" Set DMX Port 3 to output both DMX512 and RDM packets from the Art-Net protocol (default).
        break;
      case 0x70:  // "AcAcnSel0" Set DMX Port 0 to output DMX512 data from the sACN protocol and RDM data from the Art-Net protocol.
        break;
      case 0x71:  // "AcAcnSel1" Set DMX Port 1 to output DMX512 data from the sACN protocol and RDM data from the Art-Net protocol.
        break;
      case 0x72:  // "AcAcnSel2" Set DMX Port 2 to output DMX512 data from the sACN protocol and RDM data from the Art-Net protocol.
        break;
      case 0x73:  // "AcAcnSel3" Set DMX Port 3 to output DMX512 data from the sACN protocol and RDM data from the Art-Net protocol.
        break;
      case 0x90:  // "AcClearOp0" Clear DMX Output buffer for Port 0.
        break;
      case 0x91:  // "AcClearOp1" Clear DMX Output buffer for Port 1.
        break;
      case 0x92:  // "AcClearOp2" Clear DMX Output buffer for Port 2.
        break;
      case 0x93:  // "AcClearOp3" Clear DMX Output buffer for Port 3.
        break;
      case 0xA0:  // "AcStyleDelta0" Set output style to delta mode (DMX frame triggered by ArtDmx) for Port 0.
        break;
      case 0xA1:  // "AcStyleDelta1" Set output style to delta mode (DMX frame triggered by ArtDmx) for Port 1.
        break;
      case 0xA2:  // "AcStyleDelta2" Set output style to delta mode (DMX frame triggered by ArtDmx) for Port 2.
        break;
      case 0xA3:  // "AcStyleDelta3" Set output style to delta mode (DMX frame triggered by ArtDmx) for Port 3.
        break;
      case 0xB0:  // "AcStyleConst0" Set output style to constant mode (DMX output is continuous) for Port 0.
        break;
      case 0xB1:  // "AcStyleConst1" Set output style to constant mode (DMX output is continuous) for Port 1.
        break;
      case 0xB2:  // "AcStyleConst2" Set output style to constant mode (DMX output is continuous) for Port 2.
        break;
      case 0xB3:  // "AcStyleConst3" Set output style to constant mode (DMX output is continuous) for Port 3.
        break;
      case 0xC0:  // "AcRdmEnable0" Enable RDM for Port 0.
        break;
      case 0xC1:  // "AcRdmEnable1" Enable RDM for Port 1.
        break;
      case 0xC2:  // "AcRdmEnable2" Enable RDM for Port 2.
        break;
      case 0xC3:  // "AcRdmEnable3" Enable RDM for Port 3.
        break;
      case 0xD0:  // "AcRdmDisable0" Disable RDM for Port 0.
        break;
      case 0xD1:  // "AcRdmDisable1" Disable RDM for Port 1.
        break;
      case 0xD2:  // "AcRdmDisable2" Disable RDM for Port 2.
        break;
      case 0xD3:  // "AcRdmDisable3" Disable RDM for Port 3.
        break;
